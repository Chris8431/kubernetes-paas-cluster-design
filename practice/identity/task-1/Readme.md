# Identity Task 1 - Set up a service account
...
Afterward's create the service account via `kubectl apply -f sa.yaml`.

The service account will be deployed into the `default` namespace.