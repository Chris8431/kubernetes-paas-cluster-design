...
ingress.networking.k8s.io/monitoring-grafana                      nginx   grafana-<IP>.nip.io               <IP>            80      58s
ingress.networking.k8s.io/monitoring-kube-prometheus-prometheus   nginx   prometheus-<IP>.nip.io            <IP>            80      23m
```
